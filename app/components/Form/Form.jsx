    ...
    <section className="flex flex-col items-center py-12 md:py-24" id="contact">
      ...
      <form className="mt-8 flex flex-col w-full px-6 md:w-2/5">
        ...
        <textarea
          ...
          id="message"
        ></textarea>
        <button className="w-1/3 self-end pointer-events-auto rounded-3xl bg-secondary-color my-6 md:my-12 px-3 py-1 sm:text-xs md:text-lg drop-shadow-lg duration-500 hover:bg-main-color hover:text-white">
          Envoyer
        </button>
      </form>
    </section>
