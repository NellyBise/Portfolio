...
function About() {
  return (
    <section className="overflow-hidden w-full pt-24 md:pt-48 md:mb-24 flex flex-col-reverse items-center md:flex-row md:justify-center gap-12  xl:gap-36">
      <div className="md:w-2/5 text-left px-12 md:px-0 xl:px-12">
